      ...
      <div className="w-full max-w-md p-6 sm:p-8 space-y-6 bg-[rgba(256,256,256,0.1)] rounded-xl shadow-2xl backdrop-blur-md border border-white/10">
        ...
        <form className="space-y-4 sm:space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <a href="#" className="text-blue-500 hover:text-blue-600 font-medium transition">
              Forgot password?
            </a>
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className={`px-2 ${darkMode ? "bg-black/40 text-gray-400" : "bg-white text-gray-500"}`}>Or continue with</span>
          </div>
        </div>
        ...
        <p className={`text-sm text-center ${darkMode ? "text-gray-300" : "text-gray-600"}`}>
          ...
          <NavLink to="/signup" className="text-blue-600 hover:text-blue-700 font-semibold transition">
            Sign up
          </NavLink>
        </p>
      </div>

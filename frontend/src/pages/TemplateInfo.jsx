  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        {/* Header Section */}
        <div
          className={`mb-8 sm:mb-12 pb-8 border-b ${darkMode ? "border-gray-800" : "border-gray-200"}`}
        >
          <h1
          ...
          <p
            className={`text-sm sm:text-base mb-4 ${darkMode ? "text-gray-400" : "text-gray-600"}`}
          >
            {code?.description}
          </p>
          ...
          <div className="flex flex-wrap gap-4 items-center text-xs sm:text-sm mt-6">
            <div
              className={`px-3 py-1 rounded-full ${darkMode ? "bg-gray-800 text-gray-300" : "bg-gray-200 text-gray-700"}`}
            >
              {code?.language}
            </div>
                ...
                >
                  ...
                  >
                    <div className="flex-1">
                      <p
                        className={`font-mono text-sm sm:text-base font-semibold ${darkMode ? "text-white" : "text-gray-900"}`}
                      >
                        {file.name}
                      </p>
                      <p
                  ...
                  {/* Code Block */}
                  <div
                    className={`p-4 sm:p-6 font-mono text-xs sm:text-sm overflow-x-auto ${
                      darkMode ? "bg-gray-950" : "bg-gray-50"
                    }`}
                  >
                    <pre
                      className={`${darkMode ? "text-gray-300" : "text-gray-700"} whitespace-pre-wrap word-break`}
                    >

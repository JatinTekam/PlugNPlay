  ...
  return (
    <div className={`w-full h-16   sm:h-20 pt-2 sm:pt-4`}>
      ...
      >
        ...
        <div className="hidden md:flex items-center justify-center gap-3 sm:gap-4 text-[#a1a1a1]">
          ...
          {checkLoginStatus() ? (
            ...
            <>
              <button
                className={`text-sm sm:text-base hover:border-b p-1 ${darkMode ? "text-[#a1a1a1]" : "text-black"} transition duration-150 cursor-pointer`}
              >
                <NavLink to="/signup">Sign up</NavLink>
              </button>
              <button
                className={`text-sm sm:text-base hover:border-b p-1 ${darkMode ? "text-[#a1a1a1]" : "text-black"} cursor-pointer transition duration-150`}
              >
          ...
          <div
            className={`text-lg sm:text-xl p-1 ${darkMode ? "bg-black rounded-2xl" : "text-black"} cursor-pointer hover:text-white transition hover:scale-110`}
          >
      ...
      >
        ...
        <NavLink
          to="/templates"
          className={`py-4 px-4 text-base font-medium transition hover:bg-blue-500/10 ${darkMode ? "text-white hover:text-blue-400" : "text-black hover:text-blue-600"}`}
          onClick={() => setMobileMenu(false)}
        >
          Templates
        </NavLink>

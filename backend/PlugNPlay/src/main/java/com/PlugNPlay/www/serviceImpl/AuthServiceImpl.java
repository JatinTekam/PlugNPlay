...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(UserService userService, PasswordEncoder passwordEncoder, AuthenticationManager authenticationManager, UserRepository userRepository, JWTService jwtService, RefreshTokenRepository refreshTokenRepository, CookieService cookieService, ModelMapper modelMapper) {
    ...
    public UserDTO registerUser(UserDTO userDTO) {
        ...
        userResponse.setCodeSnippests(user.getCodeSnippests());
        userResponse.setCreatedTime(user.getCreatedTime());
        userResponse.setUpdatedTime(user.getUpdatedTime());
    ...
    public void logoutUser(HttpServletRequest request, HttpServletResponse response){
        readRefreshTokenFromRequest(null,request).ifPresent(token->{
            try{
                ...
                log.warn("Invalid refresh token on logout");
            }
        });
    ...
    @Override
    public TokenResponse generateNewRefreshToken(RefreshTokenRequest body, HttpServletResponse response, HttpServletRequest request) {
